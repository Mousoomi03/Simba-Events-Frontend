            ...
            <form onSubmit={handleSubmit} className={styles.form}>
                ...
                <div className={styles.ratingGrid}> 
                    <div className={styles.ratingGridRow}>
                        ...
                        <Rating rating={contentQuality} onClick={(rate) => handleRating(rate, setContentQuality)} size={23} />
                    </div>
                    <div className={styles.ratingGridRow}>
                        <label>Venue & Facilities</label>
                        <Rating rating={venueFacilities} onClick={(rate) => handleRating(rate, setVenueFacilities)} size={23} />
                    </div>
                    <div className={styles.ratingGridRow}>
                        <label>Event Organization</label>
                        <Rating rating={eventOrganization} onClick={(rate) => handleRating(rate, setEventOrganization)} size={23} />
                    </div>
                    <div className={styles.ratingGridRow}>
                        <label>Value for Money</label>
                        <Rating rating={valueForMoney} onClick={(rate) => handleRating(rate, setValueForMoney)} size={23} />
                    </div>
                </div>
